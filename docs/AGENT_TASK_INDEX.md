...
| 9 | MH-009 | P1 | Implement Codex adapter path. |
| 10 | MH-010 | P1 | Add minimal GitHub PR loop. |
...
| 14 | MH-014 | P2 | Make security gates executable. |
...
| 19 | MH-019 | P3 | Add optional kind namespace profile skeleton. |
...
| 23 | MH-023 | P3 | Add productization audit workflow. |
| 24 | MH-024 | P3 | Add release readiness workflow. |
| 25 | MH-025 | P3 | Add maintenance workflow skeleton. |
| 26 | MH-026 | P3 | Build end-to-end demo project. |
