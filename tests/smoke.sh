...
grep -q "L2_KIND_NAMESPACE:" "$TARGET/.harness/execution-profiles.yml"
grep -q "optInFlag: --enable-kind-namespace" "$TARGET/.harness/execution-profiles.yml"
grep -q "create namespace per run" "$TARGET/.harness/execution-profiles.yml"
grep -q "cleanup namespace" "$TARGET/.harness/execution-profiles.yml"
grep -q "localTaskKubernetes: false" "$TARGET/.harness/factory.yml"
test ! -e "$TARGET/infra/local-task-k8s"
...
test -f "$TARGET/.harness/maintenance/config.yml"
test -f "$TARGET/.harness/maintenance/task-types.json"
test -f "$TARGET/.harness/maintenance/templates/dependency.task-template.json"
test -f "$TARGET/.harness/maintenance/templates/security.task-template.json"
test -f "$TARGET/.harness/maintenance/templates/bugfix.task-template.json"
test -f "$TARGET/.harness/maintenance/templates/incident.task-template.json"
test -f "$TARGET/docs/operations/incident-report.md"
test -f "$TARGET/docs/operations/postmortem.md"
grep -q "maintenance-dependency" "$TARGET/.harness/maintenance/config.yml"
grep -q "maintenance-security" "$TARGET/.harness/maintenance/config.yml"
grep -q "maintenance-bugfix" "$TARGET/.harness/maintenance/config.yml"
grep -q "maintenance-incident" "$TARGET/.harness/maintenance/config.yml"
grep -q "defaultVerifyCommands" "$TARGET/.harness/maintenance/config.yml"
grep -q "Incident Report" "$TARGET/docs/operations/incident-report.md"
grep -q "Postmortem" "$TARGET/docs/operations/postmortem.md"
